...
class Chat(object):
    def __init__(self, pairs=(), reflections=None, call=_function_call,
                 api=None, normalizer=None, default_template=None, language="fr", local_path=None):
        """
...
def demo(first_question=None, language="fr", gui=None, **kwargs):
    if not first_question:
        first_question = FIRST_QUESTIONS.get(language, FIRST_QUESTIONS["fr"])
    terminate = TERMINATES.get(language, TERMINATES["fr"])
