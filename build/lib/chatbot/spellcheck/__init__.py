...
class SpellChecker:
    ...
    def __init__(self, local_path, language='fr'):
        try:
    ...
    @staticmethod
    def words(text):
        #I changed regex to support accented words
        return re.findall(r'[\wéèàùîôâêë]+', text.lower())
    ...
    def edits1(word):
        ...
        :return: set of words
        """
        #I added special characters to support accented words
